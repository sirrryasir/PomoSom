import { REST, Routes, Client, Collection, Interaction, SlashCommandBuilder, EmbedBuilder, TextChannel, PermissionFlagsBits, ChatInputCommandInteraction } from 'discord.js';
import { DatabaseService } from './DatabaseService.js';
import { WelcomeService } from './WelcomeService.js';
import { LeaderboardReporter } from './LeaderboardReporter.js';
...
export class CommandRegistry {
    ...
    private leaderboardReporter: LeaderboardReporter;
    ...
    constructor(
        ...
        leaderboardReporter: LeaderboardReporter,
    ...
    private registerCommandsInternal() {
        // --- /help ---
        const helpCommand: Command = {
            ...
            execute: async (interaction) => {
                const embed = new EmbedBuilder()
                    ...
                    .addFields(
                        { name: '📊 Statistics', value: '`/stats` - View your personal study data\n`/leaderboard` - Server rankings', inline: true },
                        { name: '⏱️ Session', value: '`/status` - Check active session\nJoin a VC to start studying!', inline: true },
                        { name: '⚙️ Configuration', value: '`/config` - Server settings (Admin only)', inline: false }
                    )
        ...
        const lbCommand: Command = {
            ...
            execute: async (interaction) => {
                ...
                await this.leaderboardReporter.sendGuildReport(interaction.guildId!, timeframe, interaction.channel as TextChannel, interaction.user.id);
            }
        };
